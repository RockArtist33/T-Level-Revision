...
##### <mark style="background: #FF5582A6;"> 1.2.4 - Understand the purpose of a given algorithm (flowcharts, written descriptions, pseudocode, program code) and how the algorithm works.</mark>
...
<a href="./T-Level-Revision-dpdd/content/Misc/pdf/t-level-spec-2020.pdf#page=23">T-Level spec 2020 page</a>